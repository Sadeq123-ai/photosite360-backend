...
const EnhancedMapView = ({ photos = [], project, onClose, onPhotoCapture }) => {
  ...
  // ✅ ESTADO PARA COORDENADAS UTM AL HOVER
  ...
  useEffect(() => {
    if (!mapInstance.current && mapRef.current) {
      ...
      // ✅ AÑADIR EVENT LISTENER PARA MOSTRAR COORDENADAS UTM AL HOVER
    ...
    return () => {
      if (mapInstance.current) {
        ...
        mapInstance.current.off('mousemove');  // ✅ Limpiar evento mousemove
  ...
  return (
    <div className="enhanced-map-view">
      ...
      {/* ✅ DISPLAY DE COORDENADAS UTM AL HOVER */}
      {hoveredCoords && (
